app.controller.map = {
    ...
    sateliteViewChange : function(e) {
        var type = Titanium.Map;
        
        if(e.value){
            type = type.SATELLITE_TYPE;
        }else{
            type = type.STANDARD_TYPE;
        }
        app.view.map.mapView.setMapType(type);
    },
...
app.view.map.sateliteSwitch.addEventListener('change', app.controller.map.sateliteViewChange);
app.view.map.centerLocationButton.addEventListener('click', app.controller.map.centerLocation);  